...
_Generated 2026-04-21T15:33:28.048Z — 12 scenarios._
...
|---|---|---|---|---|---|---|---|---|
| 01-clean-barge-in | AI is mid-segment, user barges in with a question. | ✅ | 0ms ✅ | 2 ❌ | 0 ✅ | —ms — | 2 ❌ | 291ms ⚠️ |
| 02-heavy-backend-generation-during-speech | Backend streams 5 narration segments while user is speaking. | ✅ | 0ms ✅ | 5 ❌ | 0 ✅ | —ms — | 0 ✅ | 0ms ✅ |
| 03-rapid-double-barge-in | User interrupts, AI pauses, user immediately says another th | ✅ | 1ms ✅ | 0 ✅ | 0 ✅ | 144ms ❌ | 0 ✅ | 204ms ⚠️ |
| 04-brief-cough | User coughs / says "hmm" for <200ms mid-narration. | ✅ | 0ms ✅ | 0 ✅ | 0 ✅ | 702ms ✅ | 1 ❌ | 181ms ⚠️ |
| 05-long-question | User interrupts with a full multi-second question. | ✅ | 0ms ✅ | 2 ❌ | 0 ✅ | —ms — | 2 ❌ | 1358ms ❌ |
| 06-mid-thought-pause | User speaks, pauses 900ms mid-thought, continues. AI must no | ✅ | 0ms ✅ | 0 ✅ | 0 ✅ | 302ms ❌ | 0 ✅ | 0ms ✅ |
| 07-clean-end-of-turn | User asks a full question then goes silent; AI should respon | ✅ | 0ms ✅ | 2 ❌ | 0 ✅ | 803ms ✅ | 0 ✅ | 0ms ✅ |
| 08-queue-leak | Backend emits 3 narrations back-to-back, user interrupts aft | ✅ | 0ms ✅ | 2 ❌ | 0 ✅ | —ms — | 2 ❌ | 286ms ⚠️ |
| 09-segment-boundary | User starts speaking exactly as segment N ends / N+1 starts. | ✅ | 0ms ✅ | 1 ⚠️ | 0 ✅ | —ms — | 1 ❌ | 285ms ⚠️ |
| 10-early-session-interrupt | User barges in before the greeting finishes. | ✅ | 0ms ✅ | 1 ⚠️ | 0 ✅ | —ms — | 1 ❌ | 265ms ⚠️ |
| 11-self-interrupt | Backend emits two narrations with no segment_finished betwee | ❌ | —ms — | 0 ✅ | 0 ✅ | —ms — | 1 ❌ | 0ms ✅ |
| 12-sustained-user-speech | User speaks for 3 seconds continuously. Backend keeps trying | ✅ | 0ms ✅ | 6 ❌ | 0 ✅ | —ms — | 0 ✅ | 0ms ✅ |
